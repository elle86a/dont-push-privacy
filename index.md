...
The App stores the following data **locally on your device only** using standard platform storage (SharedPreferences):
...
*This privacy policy applies to the "Dont Push!" application available on Google Play Store.*
